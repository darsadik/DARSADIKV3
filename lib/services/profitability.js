...
// sum of gasoil "pleins" manually linked to the voyage. remiseRate only
// affects the 'automatic' path (kmFuelCost) — manual modes are explicit user
// overrides and the manual-link fallback predates litre-level data, so both
// are left untouched, exactly as before this discount existed.
