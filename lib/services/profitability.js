...
export function computeFuelCost(voyage, voyageFuelMap, voyageGasoilLinks) {
...
export function computeVoyageProfit({
  ...
  voyageFuelMap = new Map(), voyageGasoilLinks = [],
}) {
  ...
  const { cost: fuel, source: fuelSource } = computeFuelCost(voyage, voyageFuelMap, voyageGasoilLinks)
