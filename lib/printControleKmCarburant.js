...
// glance, followed by the chronological table and a compact consumption
// recap line closing out the section.
function truckSection({ camion, currentKm, summary, displayRows }) {
  ...
  <div class="truck-section">
    ...
    <div class="conso-recap">Consommation globale&nbsp;&nbsp;<b>${consoStr(summary.consoL100)} L/100 KM</b></div>
  </div>`
}
...
.truck-titlebar{background:${NAVY};color:#fff;padding:9px 18px;display:flex;align-items:baseline;justify-content:space-between;flex-wrap:wrap;gap:8px}
.truck-title{font-size:15px;font-weight:800;letter-spacing:0.02em}
.truck-meta{font-size:11px;color:#cbd5e1;font-weight:600}
...
.conso-recap{background:${BG_SOFT};border-top:2px solid ${ACCENT};padding:9px 12px;margin-top:10px;font-size:11.5px;font-weight:700;color:${NAVY};text-align:right}
.conso-recap b{color:${ACCENT};font-size:14px;font-family:'Courier New',monospace}
