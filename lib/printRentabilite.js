  ...
  <div class="voy-totals">
    <table class="summary-table">
      <tbody>
        ...
        <tr><td class="sl">Gasoil</td><td class="sv" style="color:${r.cost.hasPendingFuel ? '#2563eb' : '#dc2626'}">${r.cost.hasPendingFuel ? '⏳ En attente de mesure' : '− ' + fmtMoney(r.cost.fuel) + ' DHS'}</td></tr>
...
${sorted.length > 0 ? summaryCards([
  ...
  { label: global.pendingFuelCount > 0 ? `Total Gasoil (⏳ ${global.pendingFuelCount} en attente)` : 'Total Gasoil', value: `− ${fmtMoney(global.cost.fuel)} DHS`, color: '#dc2626' },
...
${sorted.length > 0 ? `<div class="grand-totals">
  ...
  <div class="gt-grid">
    ...
    <div class="gt-item"><div class="gt-lbl">Total Gasoil${global.pendingFuelCount > 0 ? ` (⏳ ${global.pendingFuelCount} en attente)` : ''}</div><div class="gt-val" style="color:#dc2626">− ${fmtMoney(global.cost.fuel)} DHS</div></div>
