...
import { printBaseCss, printHeader, printGeneratedDate } from './printLayout'
...
.meta-bar{padding:12px 24px;border-bottom:2px solid #e2e8f0;display:flex;flex-wrap:wrap;gap:6px 22px;font-size:11.5px;color:#374151;background:#f8fafc}
.meta-bar b{color:#0f172a;font-weight:800}
...
<div class="meta-bar">
  ...
  <div><b>Filtres</b> ${filtersLabel}</div>
  <div><b>Nombre de voyages</b> ${results.length}</div>
</div>
