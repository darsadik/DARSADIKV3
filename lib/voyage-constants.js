...
export const FRAIS_LABELS = ['Transport', 'Déchargement', 'Location', "Main d'œuvre", 'Autre', 'Frais Transport', 'Frais Gasoil', 'Frais Ouvriers']

// Customer deductions: reduce the client's balance for this livraison. NOT payments.
export const DEDUCTION_LABELS = ['Transport payé', 'Transport + Ouvriers']
