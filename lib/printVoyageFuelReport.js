...
body{color:${NAVY};font-size:11px}
...
.truck-titlebar{background:${NAVY};color:#fff;padding:9px 16px;border-radius:7px 7px 0 0;display:flex;align-items:baseline;justify-content:space-between;flex-wrap:wrap;gap:6px;page-break-inside:avoid}
.truck-title{font-size:14px;font-weight:800;letter-spacing:0.02em}
.truck-meta{font-size:10.5px;color:#cbd5e1;font-weight:600}

.truck-section table{width:100%;table-layout:fixed;border:1px solid ${LINE};border-top:none;border-radius:0 0 7px 7px}
.truck-section thead th{background:${NAVY} !important;color:#fff !important;font-size:10px;font-weight:700;padding:8px 9px}
...
.truck-section th.col-gasoil{width:9%}
.truck-section th.col-l100{width:8%}
.truck-section th.col-cout{width:11%}
.truck-section th.col-plein{width:29%}
.truck-section tbody td{font-size:10.5px;font-weight:600;color:${NAVY};padding:8px 9px;overflow-wrap:break-word}
.truck-section td.dest{font-weight:600}
.truck-section td.dest .sub{font-size:8.5px;font-weight:500;color:${MUTED};margin-top:1px}
...
.note{font-family:Arial,sans-serif;font-weight:700;font-size:8px;margin-top:1px;white-space:normal}
.note-date{color:${WARN_COLOR}}
.note-missing{color:${BAD_COLOR}}
.note-pending{color:${MUTED};font-style:italic}
.truck-section td.plein{font-size:10px;font-weight:600}
.plein-item + .plein-item{margin-top:2px}
.plein-item b{font-weight:800}
.plein-flag{font-size:8px;font-weight:700;color:${WARN_COLOR};white-space:normal}
