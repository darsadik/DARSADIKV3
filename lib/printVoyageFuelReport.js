...
function pleinLabel(c) {
  ...
  return `<div class="plein-item"><b>${fmtShortDate(c.date)}</b> — ${fmtMoney(c.purchaseQte)} L${flag}</div>`
}
...
.truck-section th.col-dest{width:15%}
...
.truck-section th.col-plein{width:18%}
