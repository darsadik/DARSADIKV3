...
.truck-section thead th{background:${NAVY} !important;color:#fff !important;font-size:11.5px;font-weight:800;padding:10px 11px;overflow-wrap:break-word}
.truck-section th.col-date{width:11%}
.truck-section th.col-voyage{width:11%}
.truck-section th.col-dest{width:18%}
.truck-section th.col-km{width:7%}
.truck-section th.col-gasoil{width:11%}
.truck-section th.col-l100{width:8%}
.truck-section th.col-cout{width:14%}
.truck-section th.col-plein{width:20%}
.truck-section tbody td{font-size:12.5px;font-weight:700;color:${TEXT_DARK};padding:10px 11px;line-height:1.35;overflow-wrap:anywhere}
