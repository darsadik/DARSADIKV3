...
.truck-section thead th{background:${NAVY} !important;color:#fff !important;font-size:13.5px;font-weight:800;padding:11px 12px;overflow-wrap:break-word}
.truck-section th.col-date{width:11%}
.truck-section th.col-voyage{width:11%}
.truck-section th.col-dest{width:14%}
.truck-section th.col-km{width:7%}
.truck-section th.col-gasoil{width:12%}
.truck-section th.col-l100{width:10%}
.truck-section th.col-cout{width:16%}
.truck-section th.col-plein{width:19%}
.truck-section tbody td{font-size:14.5px;font-weight:700;color:${TEXT_DARK};padding:11px 12px;line-height:1.4;overflow-wrap:anywhere}
...
.truck-section tbody td.r{font-weight:800;font-family:'Courier New',monospace;white-space:normal}
