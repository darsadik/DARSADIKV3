  ...
  function printClient() {
    ...
    win.document.write(`
      ...
      * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; color-adjust: exact !important; }
      body { font-family: Arial, sans-serif; padding: 28px; font-size: 12px; color: #1a2742 !important; background: #fff !important; margin: 0; }
      h1 { font-size: 18px; margin: 0 0 4px; color: #1a2742 !important; }
      h2 { font-size: 15px; color: #1a2742 !important; }
      ...
      td { padding: 7px 10px; border-bottom: 1px solid #e2e8f0; font-size: 11px; color: #1a2742 !important; }
      tr:nth-child(even) td { background: #f8fafc !important; }
      tfoot td { background: #f1f5f9 !important; font-weight: 800 !important; color: #1a2742 !important; border-top: 2px solid #2563eb !important; font-size: 12px; }
      b, strong { color: #1a2742 !important; font-weight: 800; }
      ...
      .badge { display: inline-block; padding: 2px 8px; border-radius: 20px; font-size: 10px; font-weight: 700; background: #e2e8f0 !important; color: #1a2742 !important; border: 1px solid #cbd5e1; }
      ...
      .prod-header { background: #f1f5f9 !important; border-left: 4px solid #1a5fa8; padding: 5px 10px; font-weight: 700; font-size: 11px; color: #1a2742 !important; margin-bottom: 4px; border-radius: 0 4px 4px 0; }
      .grand-tfoot td { background: #e2e8f0 !important; font-weight: 900 !important; color: #1a2742 !important; border-top: 3px solid #1a5fa8 !important; font-size: 13px; }
      ...
      .info-box b { display: block; margin-bottom: 4px; color: #1a2742 !important; font-size: 10px; text-transform: uppercase; letter-spacing: 0.05em; }
      .lbl { font-size: 10px; font-weight: 700; color: #4b5563 !important; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px; }
      .val { font-size: 22px; font-weight: 900; color: #1a2742 !important; }
      .val.red { color: #dc2626 !important; }
      .val.blue { color: #1a5fa8 !important; }
