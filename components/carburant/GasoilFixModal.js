...
// ── Quick-fix overlay (spec §10) — minimal correction form (KM, camion) for
// a single gasoil row, scoped to exactly what the Control Center's Missing
// Data list needs. Deliberately not the full plein editor (diesel/AdBlue
// amounts, station, bon) — that stays in pages/gasoil/index.js, this only
// ever touches km/camion_id so it can never diverge from the real edit
// form's totals math.
